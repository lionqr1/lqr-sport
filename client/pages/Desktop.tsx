          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-300">
                <a
                  href="mailto:mail.lqrsport@dr.com"
              ...
              {loading.liveTV ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {filteredLiveTV.map((stream) => (
                    <Card
                      key={stream.id}
                      className="bg-gray-800 border-gray-700 hover:bg-gray-750 transition-colors group hover:shadow-xl"
                    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card className="bg-gray-800 border-gray-700">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-gray-300 leading-relaxed">
                      LQR SPORT is your premier destination for Haitian media
                      content, offering live streaming, radio stations, and the
                      latest updates from Haiti and beyond.
                    </p>
                    <p className="text-gray-300 leading-relaxed">
                      Get in touch with us for any questions, feedback, or
                      support regarding our streaming services. We're committed
                      to providing you with the best Haitian media experience.
                    </p>
                    ...
                    <div className="pt-4 border-t border-gray-600">
                      ...
                      <p className="text-sm text-gray-400">
                        All channels featured on LQR SPORT are publicly
                        available from the internet. We do not host, own, or
                        claim any rights over the content displayed.
                      </p>
