    ...
    <>
      <header className="sticky top-0 z-40 w-full bg-black border-b border-gray-800">
        <div className="px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:block text-sm text-gray-300">Menu</div>
        </div>
      </header>

      {/* Left Sidebar Menu */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-gray-900 border-r border-gray-800 transform transition-transform duration-300 ease-in-out z-50 ${
